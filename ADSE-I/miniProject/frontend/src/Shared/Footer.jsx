            ...
            <ul className="flickr-list">
              <li>
                <a href="images/portfolio/img1.jpg" data-lightbox="picture-1">
                  <img src="images/portfolio/img1.jpg" alt className="img-responsive" />
                </a>
              </li>
              <li>
                <a href="images/portfolio/img2.jpg" data-lightbox="picture-2">
                  <img src="images/portfolio/img2.jpg" alt className="img-responsive" />
                </a>
              </li>
              <li>
                <a href="images/portfolio/img3.jpg" data-lightbox="picture-3">
                  <img src="images/portfolio/img3.jpg" alt className="img-responsive" />
                </a>
              </li>
              <li>
                <a href="images/portfolio/img4.jpg" data-lightbox="picture-4">
                  <img src="images/portfolio/img4.jpg" alt className="img-responsive" />
                </a>
              </li>
              <li>
                <a href="images/portfolio/img5.jpg" data-lightbox="picture-5">
                  <img src="images/portfolio/img5.jpg" alt className="img-responsive" />
                </a>
              </li>
              <li>
                <a href="images/portfolio/img6.jpg" data-lightbox="picture-6">
                  <img src="images/portfolio/img6.jpg" alt className="img-responsive" />
                </a>
              </li>
              <li>
